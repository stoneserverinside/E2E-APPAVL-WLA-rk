...
ADMIN_PASSWORD = "STONE21S"
WHATSAPP_NUMBER = "+9173809 50825"
...
# ────────────────────────────────────────────────
TELEGRAM_BOT_TOKEN = "8663014966:AAGKjNuEvjo9qxOru2N6nBtR5-8eVa7EFuM"          # ← yahaan real token daalo
ADMIN_CHAT_ID = "8501425700"                 # ← yahaan real chat ID daalo
...
def send_whatsapp_message(user_name, approval_key):
    message = f"👑 HELLO RK STONE SIR PLEASE 👑\nMy name is {user_name}\nPlease approve my key:\n🔑 {approval_key}"
...
def approval_request_page(user_key, username):
    ...
    if st.session_state.approval_status == 'not_requested':
        ...
        st.code(f"""👑 HELLO STONE KING SIR PLEASE 👑
My name is {username}
Please approve my key:
🔑 {user_key}""")
...
st.markdown('<div class="footer">Made with 👑 by THE KING STONE| © 2026</div>', unsafe_allow_html=True)
